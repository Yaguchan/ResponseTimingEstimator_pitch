...
DATAROOT="/mnt/aoni04/yaguchi/code/ResponseTimingEstimator2/data/ATR_Annotated/data_-500_2000"
# DATAROOT="/mnt/aoni04/yaguchi/code/ResponseTimingEstimator2/data/ATR_Annotated/test/re_1000/data_-500_2000"
CSVDIR  = os.path.join(DATAROOT, "csv")
WAVDIR="/mnt/aoni04/yaguchi/code/ResponseTimingEstimator2/data/ATR_Annotated/make_annotated_data/wav_mono"
...
if __name__ == '__main__':
    ...
    for file_path in tqdm(file_paths):
        ...
        for i in range(len(df)):
            ...
            wav_start = nxt_start           # start - OFFSET
            wav_end = nxt_end               # max(end, nxt_start+MAX_AGENT_LENGTH) + OFFSET
            
            wavpath = os.path.join(WAVDIR, '{}_agent.wav'.format(file_name))
            wav_out_dir = os.path.join(DATAROOT, 'nxt_wav', file_name)
