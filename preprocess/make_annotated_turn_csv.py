...
DATAROOT="/mnt/aoni04/yaguchi/code/ResponseTimingEstimator_DA/data/ATR_Annotated/make_annotated_data"
# DATAROOT="/mnt/aoni04/yaguchi/code/ResponseTimingEstimator_DA/data/ATR_Annotated/make_annotated_data_test"
OUT_DATAROOT="/mnt/aoni04/yaguchi/code/ResponseTimingEstimator_DA/data/ATR_Annotated/"
# OUT_DATAROOT="/mnt/aoni04/yaguchi/code/ResponseTimingEstimator_DA/data/ATR_Annotated/test/1000"
MIN=-500
MAX=1000

def get_csv(name):
    path = os.path.join(DATAROOT, "dataframe", name+'.csv')
    df = pd.read_csv(path)
...
if __name__ == '__main__':
    ...
    names2 = [name.replace('.csv', '') for name in os.listdir(os.path.join(DATAROOT, "dataframe"))]
