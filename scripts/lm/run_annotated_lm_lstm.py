...
from src.datasets.dataset_annotated_lm import get_dataloader, get_dataset
from src.utils.utils import load_config
from src.utils.trainer_lm import trainer
from src.models.lm.model import LSTMLM

# python scripts/lm/run_annotated_lm_lstm.py configs/lm/annotated_char_lstm_l1.json --gpuid 0
